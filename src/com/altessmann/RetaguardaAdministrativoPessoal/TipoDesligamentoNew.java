 ...
 * @author EngComp
 */
public class TipoDesligamentoNew extends javax.swing.JFrame {

    /**
     * Creates new form TipoDesligamentoNew
     */
    public TipoDesligamentoNew() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoDesligamentoNew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipoDesligamentoNew().setVisible(true);
            }
        });
    }
