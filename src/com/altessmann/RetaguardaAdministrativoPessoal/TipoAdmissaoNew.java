 ...
 * @author EngComp
 */
public class TipoAdmissaoNew extends javax.swing.JFrame {

    /**
     * Creates new form TipoAdmissaoNew
     */
    public TipoAdmissaoNew() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoAdmissaoNew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipoAdmissaoNew().setVisible(true);
            }
        });
    }
